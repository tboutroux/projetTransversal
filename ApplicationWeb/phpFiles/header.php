...
<head>
    ...
    <link rel="stylesheet" href="/projetTransversal/ApplicationWeb/styleSheet/style.css" type="text/css">
    <link rel="shortcut icon" href="/projetTransversal/ApplicationWeb/picture/logo-chimere.svg" type="image/x-icon">
